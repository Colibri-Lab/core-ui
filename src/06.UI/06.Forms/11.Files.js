...
Colibri.UI.Forms.Field.RegisterFieldParam('Colibri.UI.Forms.Files', 'allow', {
    type: 'varchar',
    component: 'Text',
    placeholder: '#{ui-files-fieldparams-allow}',
    note: '#{ui-files-fieldparams-allow-note}',
    params: {
        condition: {
            field: 'component',
...
Colibri.UI.Forms.Field.RegisterFieldParam('Colibri.UI.Forms.Files', 'size', {
    type: 'int',
    component: 'Number',
    placeholder: '#{ui-files-fieldparams-size}',
    note: '#{ui-files-fieldparams-size-note}',
    params: {
        condition: {
            field: 'component',
...
Colibri.UI.Forms.Field.RegisterFieldComponent('Files', 'Colibri.UI.Forms.Files', '#{ui-files-files}', null, ['required', 'enabled', 'canbeempty', 'readonly', 'list', 'template', 'greed', 'viewer', 'fieldgenerator', 'generator', 'transformer', 'noteClass', 'validate', 'valuegenerator', 'onchangehandler', 'allow', 'size'])
