...
Colibri.UI.Forms.NumberRangePicker = class extends Colibri.UI.Forms.Field {
    ...
    RenderFieldContainer() {
        ...
        this._flex.AddClass('app-component-numberrangepicker-flex');

        this._inputFlex = new Colibri.UI.FlexBox(this.name + '_inputflex', this._flex);
        this._input1 = new Colibri.UI.Input(this.name + '_input1', this._inputFlex);
        this._input2 = new Colibri.UI.Input(this.name + '_input2', this._inputFlex);
        this._pane = new Colibri.UI.Pane(this.name + '_pane', this._flex);
        this._pane.AddClass('app-component-numberrangepicker-progress-pane');
        this._maxmin = new Colibri.UI.FlexBox(this.name + '_maxmin', this._flex);
        this._maxmin.AddClass('app-component-numberrangepicker-maxmin');

        this._progress = new Colibri.UI.Pane(this.name + '_progress', this._pane);
        this._span1 = new Colibri.UI.Pane(this.name + '_span1', this._progress);
        this._span2 = new Colibri.UI.Pane(this.name + '_span2', this._progress);
        ...
        this._flex.shown = this._inputFlex.shown = this._input1.shown = 
...
Colibri.UI.Forms.Field.RegisterFieldComponent('NumberRangePicker', 'Colibri.UI.Forms.NumberRangePicker', '#{ui-fields-numberrangepicker}', Colibri.UI.FieldIcons['Colibri.UI.Forms.Number']);
