...
Colibri.UI.Forms.Field.RegisterFieldComponent('DocumentGenerator', 'Colibri.UI.Forms.DocumentGenerator', '#{ui-fields-documentgenerator}', null, ['required','enabled','canbeempty','readonly','list','template','greed','viewer','fieldgenerator','generator','transformer','noteClass','validate','valuegenerator','onchangehandler'])
