...
Colibri.UI.Forms.Token = class extends Colibri.UI.Forms.Field {
    ...
    RenderFieldContainer() {
        ...
        this._button.value = '#{ui-fields-token-generate}';
...
Colibri.UI.Forms.Field.RegisterFieldComponent('Token', 'Colibri.UI.Forms.Token', '#{ui-fields-token}', null, ['required', 'enabled', 'canbeempty', 'readonly', 'list', 'template', 'greed', 'viewer', 'fieldgenerator', 'transformer', 'noteClass', 'validate', 'valuegenerator', 'onchangehandler']);
