...
Colibri.UI.Forms.Field.RegisterFieldComponent('NumberRange', 'Colibri.UI.Forms.NumberRange', '#{ui-fields-numberrange}', null, ['required','enabled','canbeempty','readonly','list','template','greed','viewer','fieldgenerator','generator','transformer','noteClass','validate','valuegenerator','onchangehandler'])